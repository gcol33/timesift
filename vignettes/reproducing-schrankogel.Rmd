...
positive-class weight capped at 50, under which the validation loss is read as the fitting loss
is. The encoders of the study read batches of 32 plots, which the grid asks for; the default is
64.
